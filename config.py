...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5732190759:AAFjs0S17YrfEQjBI3YF0f16P9xnCzCSO6w")
    ...
    LAZY_DEVELOPER = set(int(x) for x in os.environ.get("LAZY_ADMIN", "1571060413").split())
